...
def create_parser():
    ...
    parser.add_argument('-dt','--dataset_train', type=str, default='kahikatea')
    # parser.add_argument('-dt','--dataset_train', type=str, default='mix2')
    ...
    parser.add_argument('-dv','--dataset_vals',type=str, default='GrabCut')
    ...
    parser.add_argument('-toe','--train_only_epochs', type=int, default=10)
    parser.add_argument('-vri','--val_robot_interval', type=int, default=10)
    parser.add_argument('-svr','--save_val_robot', type=str, default='best',choices=['no','each','best'])
    # parser.add_argument('-svr','--save_val_robot', type=str, default='each',choices=['no','each','best'])

    #[validation only]
    # parser.add_argument('-r','--resume', type=str, default="/home/hpe/wey/focuscut/snapshot/hrcnet_base_[-rf -ap backbone='resnet50']_[2023-11-20_23_50_08]/best_87_m.pth")
    ...
    if p['snapshot_path']=='auto':
        p['snapshot_path']= './snapshot/{}_[{}]_[{}]'.format(p['model'],p['note'],time.strftime('%Y-%m-%d_%H_%M_%S',time.localtime(time.time())))
